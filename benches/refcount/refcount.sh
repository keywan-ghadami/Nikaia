...
#
# The method, the machine and the spread are in `docs/history/rc-or-arc.md`; this script
# prints the machine and the load so a table can never be read without them
# (`docs/history/runtime-cost.md` §6.3: absolutes on this box move by 1.4–1.9× from one
