...
the evidence [`docs/history/rc-or-arc.md`](../../docs/history/rc-or-arc.md) rests on.
...
table here cannot be read without them: [`docs/history/runtime-cost.md`](../../docs/history/runtime-cost.md)
...
Two differences are real and are named in `docs/history/rc-or-arc.md` §2 rather than
