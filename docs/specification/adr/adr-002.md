...
**Date:** 2026-01-18
**Status:** Superseded by [ADR-003](adr-003.md) (itself superseded ADR 001)
...
* **Code Generation:**
  * `nikaia build` utilizes `-Z codegen-backend=cranelift` for sub-second development iterations.
    *Superseded by [ADR-019](adr-019.md) D9: this claim was never measured. Cranelift is compatible
