...
> the compiler reports are `NK1101`–`NK1113` and `NK1115`–`NK1122` — every one
> of them except the **retired** `NK1114` and the unused `NK1120` — and
> `NK2101`, `NK2103`, `NK2202`, `NK2302`, `NK2501`, `NK2502`, `NK2605` and
