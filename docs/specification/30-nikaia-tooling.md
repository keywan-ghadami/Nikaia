...
> are reserved words **with constructs** ([ADR-121](adr/adr-121.md) D1), the
...
*   **`unsafe`:** this was the keyword's only specified use, and it was held
    ...
    same change ([ADR-121](adr/adr-121.md) D1). What 15.1 writes it for is a
