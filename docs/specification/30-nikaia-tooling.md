...
> are reserved words **with constructs** ([ADR-119](adr/adr-119.md) D1), the
...
*   **`unsafe`:** this was the keyword's only specified use, and it was held
    ...
    same change ([ADR-119](adr/adr-119.md) D1). What 15.1 writes it for is a
